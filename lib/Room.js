...
var Room = (function () {
    function Room(id, host, options) {
        ...
        if (this.options.remote) {
            var userID = Utility_1.Utility.generateString();
            this.creator = new User_1.User(userID, host);
            this.add(this.creator);
            message.data.push(id + userID);
            this.users[userID] = this.creator;
            this.creator.send(message);
            this.host = null;
            this.remoteHost = new Host_1.Host(id);
    ...
    Room.prototype.getRemoteHost = function () {
        return this.remoteHost;
    };
    Room.prototype.getRemoteCreator = function () {
    ...
    Room.prototype.route = function (message) {
        ...
        if (message.sender !== this.id) {
            var origin = this.find(message.sender.slice(4, 8));
            if (origin === null) {
                return Types_1.ErrorCode.USERNOTFOUND;
            }
            if (this.options.remote) {

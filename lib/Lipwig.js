...
var Lipwig = (function (_super) {
    ...
    function Lipwig(options) {
        if (options === void 0) { options = {}; }
        var _this = _super.call(this) || this;
        options.name = options.name || '';
        options.port = options.port || Types_1.DEFAULTS.port;
        ...
        _this.rooms = {};
        _this.connections = [];
        _this.reserved = new EventManager_1.EventManager();
    ...
    Lipwig.prototype.exit = function () {
        ...
        if (this.options.http instanceof http.Server || this.options.http instanceof https.Server) {
            ...
            var httpList = this.options.http;
            httpList.forEach(function (instance) {
                instance.close();
